...
/**
 * функция ораатывает клик по кнопке в карточке товара и попеременно вызывает
...
function showMoreText(card){
    ...
    const text = 'Zdes doljen but kakoy-to text nabrannyj ot baldy, no eto prosto nabor symwolow';
